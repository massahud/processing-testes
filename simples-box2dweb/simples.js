...
function init(asd) {
    ...
    */
    ...
    for (var i = 0; i < 10; i++) {
        ...
        createBox(largura/2+Math.random()*(WORLD_WIDTH-largura),altura/2+Math.random()*(WORLD_HEIGHT-altura),largura/2,altura/2, 0.3, b2Body.b2_dynamicBody, altura*largura*5, 1, 1, blocos[parseInt(Math.random()*(blocos.length+1))]);
    }
